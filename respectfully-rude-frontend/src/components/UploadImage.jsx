...
const UploadImage = ({ setForm, mode, oldForm }) => {
  ...
  return (
    <div className="text-black">
      ...
      <div className=" border-[var(--primary-color)] h-45 border-2 border-dashed mt-5 rounded-xl p-10 2xl:p-20">
        {file ? (
          <ImgList data={file} setFile={setFile} mode={mode} />
        ) : (
      ...
      <div className="mt-3 mb-3 text-gray-500 text-sm">
        Please confirm you have permission to use this image.
      </div>
    </div>
  );
};
