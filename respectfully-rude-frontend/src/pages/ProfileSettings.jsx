...
const ProfileSettings = () => {
  ...
  const onEditInfo = async () => {
    await edit(form.name, form.email, form.oldPassword, form.newPassword);
  };

  return (
    <div>
      <div className="ml-5 text-left text-3xl text-bold  mt-5 font-bold">
        Profile Settings
      </div>
      ...
      <div className="max-w-4xl mx-auto p-6 bg-white mt-2">
        ...
        <div className="flex justify-center">
          <AlertBox
            buttonName={"Logout"}
            css={
              "px-6 py-2 border border-outline bg-white text-black rounded-2xl font-medium hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 transition-all"
            }
